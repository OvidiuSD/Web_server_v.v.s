...
public class Test5VVSTest {
  ...
  public void test5VVS() {
    ...
    driver.findElement(By.cssSelector("input:nth-child(2)")).sendKeys("Popescu Marin");
    driver.findElement(By.cssSelector("input:nth-child(4)")).sendKeys("Timisoara");
